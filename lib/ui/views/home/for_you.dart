...
import 'package:g4amst/utils/info.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("For You", style: TextStyle(color: AppColors.text_light),),
      ),
      body: _body(),
    );
  }
      ...
      children: [
        ...
        Padding(
          ...
          child: Text("Discounts",
              style: TextStyle(color: AppColors.text_light, fontSize: 34, fontWeight: FontWeight.bold)),),
        _promo(),
        Padding(
          padding: EdgeInsets.all(10),
          child: Text("Shirts",
              style: TextStyle(color: AppColors.text_light, fontSize: 30, fontWeight: FontWeight.bold)),),
        _shirts(),
        Padding(
          padding: EdgeInsets.all(10),
          child: Text("Pants",
